...
<div class="container-fluid">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Silahkan pilih menu favoritmu dan lakukan pemesanan.</p>
        </div>

        <div class="d-flex gap-2">
            <a href="{{ route('pelanggan.keranjang.index') }}" class="btn btn-success rounded-3 px-4">
                ...
                @if(request('q'))
                    <div class="mt-3">
                        <span class="text-muted small">
                            Hasil pencarian untuk: <b>"{{ request('q') }}"</b>
                        </span>
                        <a href="{{ route('pelanggan.menu.index') }}" class="btn btn-sm btn-light ms-2">
                            Reset
                        </a>
                    </div>
                @endif
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden">
                    ...
                    <div class="card-body p-3">
                        ...
                        <p class="text-muted small mb-2" style="min-height:40px;">
                            {{ $row->deskripsi ? Str::limit($row->deskripsi, 70) : 'Tidak ada deskripsi produk.' }}
                        </p>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body text-center py-5">
                        ...
                        <h5 class="fw-bold mb-2">Menu tidak ditemukan</h5>
